...
public class Ipad_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        products.add((new Product(R.drawable.ipad1,"Custom Case", 190000)));
        products.add((new Product(R.drawable.ipad2,"Custom Case", 190000)));
        products.add((new Product(R.drawable.ipad3,"Custom Case", 190000)));
        products.add((new Product(R.drawable.ipad4,"Custom Case", 190000)));
        products.add((new Product(R.drawable.ipad5,"Custom Case", 190000)));
        products.add((new Product(R.drawable.ipad6,"Custom Case", 190000)));
        products.add((new Product(R.drawable.ipad7,"Custom Case", 190000)));
        products.add((new Product(R.drawable.ipad8,"Custom Case", 190000)));
        products.add((new Product(R.drawable.ipad1,"Custom Case", 190000)));
